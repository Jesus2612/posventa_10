...
<body>
    <div class="ticket">
	    ...
	    <p class="margin-between size"><strong>Dirección:</strong> {{$settings->adress}}</p>
	    <p class="margin-between size" ><strong>Teléfono:</strong> {{$settings->phone}}</p>
        ...
        <div class="ticket-total">
            ...
            <p class="margin-between size"><strong>Cambio:</strong> {{$suelto}}</p>
        </div>
        <div class="ticket-items" >
