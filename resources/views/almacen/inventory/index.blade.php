                ...
                <table id="inventory_table" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $prod->pventa}}</td>
                            <td>
                                <button class="btn btn-primary btn-sm" id="btn{{$prod->idarticulo}}" dataId="{{$prod->idarticulo}}" name="btnAjustar">Ajustar</button>
                                <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#barcodeModal" onclick="fnShowModalBarcode({{$prod->idarticulo}});"><i class="fa fa-barcode"></i></button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
